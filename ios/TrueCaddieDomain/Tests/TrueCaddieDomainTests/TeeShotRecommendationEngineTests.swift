...
final class TeeShotRecommendationEngineTests: XCTestCase {
    func testBuildsTeeShotRecommendationFromCurrentOverlays() throws {
    ...
    func testRoundContextCanClubUpIntoHeadwind() throws {
        let bundle = try loadBundle(from: """
        {
          "schema_version": "v1",
          "bundle_version": "test-bundle",
        ...
        let roundContext = RoundContext(
            ...
            wind: WindContext(relativeDirection: .hurting, speedMps: 6.0)
        )
