...
final class ApproachShotRecommendationEngineTests: XCTestCase {
    ...
    func testReachableButGuardedPar5StillPrefersLayup() throws {
        let bundle = try loadBundle(from: """
        {
          "schema_version": "v1",
          "bundle_version": "test-bundle",
    ...
    func testRoughLiePushesApproachTowardSaferTarget() throws {
        let bundle = try loadBundle(from: """
        {
          "schema_version": "v1",
          "bundle_version": "test-bundle",
        ...
        XCTAssertEqual(packet?.recommendationType, "approach")
        XCTAssertEqual(packet?.targetLabel, "Front-center green")
        XCTAssertEqual(packet?.shotDistanceM, 112)
        XCTAssertEqual(packet?.riskLevel, "medium")
        XCTAssertEqual(packet?.recommendedClub, "PW")
        XCTAssertEqual(packet?.clubCarryDistanceM, 118)
    }
